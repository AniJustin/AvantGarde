...
public struct EZLoadingActivity {
    ...
    public struct Settings {
        ...
        public static var SuccessText = "Welcome to Sharad Technologies"
        public static var FailText = "Please provide correct passcode."
    ...
    fileprivate class LoadingActivity: UIView {
        ...
        convenience init(text: String, disableUI: Bool) {
            ...
            activityView.frame = CGRect(x: 10, y: yPosition, width: 50, height: 100)
            ...
            textLabel.font = UIFont(name: Settings.FontName, size: 40)
